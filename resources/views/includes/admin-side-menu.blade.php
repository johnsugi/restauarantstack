            ...
            <ul class="navbar-nav flex-column">
                        ...
                        <ul class="nav flex-column">
                          <li class="nav-item">
                              ...
                              <div id="submenu-1-1" class="collapse submenu" style="">
                                  <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/admin/food-categories">All Food Category <span class="badge badge-secondary">New</span></a>
                                    </li>
                                    <li class="nav-item">
                          ...
                          <li class="nav-item">
                              <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2-1" aria-controls="submenu-2-1">All Food Items</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="submenu-5" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="pages/cards.html">General Setting <span class="badge badge-secondary">New</span></a>
                            </li>
