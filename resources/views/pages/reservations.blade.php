...
@section('content')
    ...
    <form>
      <div class="form-group">
        ...
        <input name="fname"type="text" class="form-control" id="firstnameinput" placeholder="Frank">
      </div>
      <div class="form-group">
        <label for="lastnameinput">Last Name #</label>
        <input name="lname"type="text" class="form-control" id="lastnameinput" placeholder="Davis">
      </div>
  <div class="form-group">
