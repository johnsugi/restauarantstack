                                ...
                                <div class="card-body">
                                    <form action="#" id="basicform" data-parsley-validate="" novalidate="">
                                        <div class="form-group">
                                            ...
                                            <input id="inputCategory" type="text" name="name" data-parsley-trigger="change" required="" placeholder="Enter category name" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputCategoryImageUrl">Category Image Url</label>
                                            <input id="inputCategoryImageUrl" type="text" name="image_url" data-parsley-trigger="change" required="" placeholder="http://wwww.billys.com/img/burguers.jpg" autocomplete="off" class="form-control">
                                        </div>
